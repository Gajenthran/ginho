...
class Profile extends React.Component {
  constructor(props) {
    ...
    this.fetchUpdatePersonalInformations = this.fetchUpdatePersonalInformations.bind(this);
  ...
  async fetchUpdatePersonalInformations(url, data) {
  ...
  handleSubmit() {
    this.fetchUpdatePersonalInformations(
